...
entity myproject_lshr_128ns_8ns_128_6_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 128;  --data bitwidth
      din1_WIDTH : INTEGER := 128;    --shift control bitwidth
      dout_WIDTH : INTEGER := 128;  --output bitwidth
...
end entity myproject_lshr_128ns_8ns_128_6_1;
architecture rtl of myproject_lshr_128ns_8ns_128_6_1 is
